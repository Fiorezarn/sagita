          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <P>Jumlah Data : {{$totalmakanan}}</P>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->

        <a href="/makanan/add" class="btn btn-primary btn-sm">Add Barang</a>
        <br><br>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="/makanan/detail/{{ $item->id }}" class="btn btn-sm btn-success">Detail</a>
                <a href="/makanan/edit/{{ $item->id }}" class="btn btn-sm btn-warning">Edit</a>
              ...
              <div class="modal-dialog">
                <div class="modal-content bg-danger">
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <a href="/makanan/delete/{{ $item->id }}" class="btn btn-outline-light">Iya</a>
                  </div>
                </div>
                <!-- /.modal-content -->
              </div>
