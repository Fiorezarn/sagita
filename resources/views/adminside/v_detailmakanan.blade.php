      ...
      <div class="content-header">
        ...
        <table class="table">
            <tr>
                ...
                <th width="30px">:</th>
                <th>{{ $makanan->namabarang }}</th>
            </tr>
            <tr>
                <th width="100px">Deskripsi</th>
                <th width="30px">:</th>
                <th>{{ $makanan->deskripsi }}</th>
            </tr>
            <tr>
                <th width="100px">Harga</th>
                <th width="30px">:</th>
                <th>{{ number_format($makanan->harga, 0, ',', ',') }}</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th width="30px">:</th>
                <th>{{ $makanan->kategori }}</th>
            </tr>
            <tr>
                <th width="100px">Gambar</th>
                <th width="30px">:</th>
                <th><img src="{{ url('foto_produk/' . $makanan->gambar) }}" width="400px"></th>
            </tr>
            <tr>
                <th><a href="/makanan" class="btn btn-success btn-sm">Back</a></th>
            </tr>
        </table>
