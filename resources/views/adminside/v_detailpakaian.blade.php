      ...
      <div class="content-header">
        ...
        <table class="table">
            <tr>
                ...
                <th width="30px">:</th>
                <th>{{ $pakaian->namabarang }}</th>
            </tr>
            <tr>
                <th width="100px">Deskripsi</th>
                <th width="30px">:</th>
                <th>{{ $pakaian->deskripsi }}</th>
            </tr>
            <tr>
                <th width="100px">Harga</th>
                <th width="30px">:</th>
                <th>{{ number_format($pakaian->harga, 0, ',', ',') }}</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th width="30px">:</th>
                <th><img src="{{ url('foto_produk/' . $pakaian->gambar) }}" width="400px"></th>
            </tr>
            <tr>
                <th><a href="/pakaian" class="btn btn-success btn-sm">Back</a></th>
            </tr>
        </table>
