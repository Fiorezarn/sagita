        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tambahkan Barang</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <form action="/pakaian/insert" method="POST"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="namabarang" class="form-control" value="{{ old('namabarang') }}">
                                        <div class="text-danger">
                                            @error('namabarang')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="kategori" class="form-control" value="pakaian">
                                        <div class="text-danger">
                                            @error('kategori')
                                                {{ $message }}
                                            @enderror
